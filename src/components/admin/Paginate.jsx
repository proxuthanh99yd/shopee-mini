...
const Paginate = memo(function Paginate({ total }) {
    return (
        <div className="flex items-center justify-between rounded border-t border-gray-200 bg-slate-100 px-4 py-3 sm:px-6 md:rounded-t-none">
