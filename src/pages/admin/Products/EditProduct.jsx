...
export default function EditProduct() {
    ...
    const handleCreate = () => {
        ...
        thumbRef.current.forEach((e, i) => {
            if (e?.id) {
                formData.append(`thumbnail_id[${i + 1}]`, e.id);
                formData.append(`thumbnail[${i + 1}]`, e.name);
            } else {
        ...
        product.classify.forEach((e, i) => {
            if (e?.id) {
                formData.append(`variation_id[${i + 1}]`, e.id);
        ...
        dispatch(updateProducts({ id: id, value: formData }));
    };
    ...
    const handleRemoveImage = () => {
        dispatch(removeImagePreview({ type: "edit" }));
        imageRef.current = "";
    };
    const handleRemoveThumb = (index) => {
        dispatch(removeThumbPreview({ type: "edit", value: index }));
                ...
                <div className="mt-5">
                    ...
                    <div className="relative ml-auto mt-3 w-10/12 rounded bg-neutral-300 p-5 pr-16">
                        <div className="flex items-center">
                            ...
                            <button
                                onClick={() =>
                                    dispatch(setNewClassify({ type: "edit" }))
                                }
                                type="button"
